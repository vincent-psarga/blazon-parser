...
export const FrenchVariationType: Translation<VariationType, FrenchWord> = {
  ...
  [FieldType.bendy]: new FrenchWord(
    'bandé',
  ...
  [FieldType.chevronny]: new FrenchWord(
    'chevronné',
